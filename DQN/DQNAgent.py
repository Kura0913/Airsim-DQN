...
class DQNAgent:
    def __init__(self, state_dim, action_dim, buffer_capacity = 10000, bacth_size = 64, epsilon = 1, epsilon_min = 0.2, epsilon_decay = 0.999,decay_episode = 500, gamma = 0.9, device = 'cpu'):
    ...
    def train(self, episode):
        ...
        if self.epsilon > self.epsilon_min and episode >= self.decay_episode:
